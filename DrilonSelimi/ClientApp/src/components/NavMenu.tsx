...
export default class NavMenu extends React.PureComponent<{}, { isOpen: boolean }> {
    ...
    public render() {
        return (
            <header>
                <Navbar className="navbar-expand-sm navbar-toggleable-sm border-bottom box-shadow mb-3" style={{backgroundColor:"#f0f2f4",fontWeight:"bold"}} light>
                    <Container>
                        <NavbarBrand tag={Link} to="/">Drilon Selimi</NavbarBrand>
